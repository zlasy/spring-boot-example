...
{
    private static final String TRAIN_FILE_NAME = "data/test/word2vec_source.txt";
    private static final String MODEL_FILE_NAME = "data/test/word2vec.txt";

    public static void main(String[] args) throws IOException
    {
        WordVectorModel wordVectorModel = trainOrLoadModel();
        printNearest("送货", wordVectorModel);
        printNearest("订单", wordVectorModel);
        printNearest("发票", wordVectorModel);
        System.out.println(wordVectorModel.similarity("配送", "发货"));
        ...
        printNearestDocument("发票", documents, docVectorModel);
        printNearestDocument("配送", documents, docVectorModel);
        printNearestDocument("退换货", documents, docVectorModel);
        printNearestDocument("退款", documents, docVectorModel);
    }
